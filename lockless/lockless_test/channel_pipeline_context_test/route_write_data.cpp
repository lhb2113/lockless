 ...
 */
TEST_F(channel_pipeline_context_test, route_write_data_all_1)
{
    ...
    htest->set_write_handler(lockless_data::socket_stream, [&go_test](std::shared_ptr<channel_data> _data, std::shared_ptr<router_info>)
                            {
    ...
    ha->set_write_handler(lockless_data::socket_stream, [&go_a](std::shared_ptr<channel_data> _data, std::shared_ptr<router_info>)
                         {
                             ASSERT_EQ(_data->get_type(), lockless_data::socket_stream);
                             go_a.set_value();
                         });
    ...
    ha1->set_write_handler(lockless_data::socket_stream, [&go_a1](std::shared_ptr<channel_data> _data, std::shared_ptr<router_info>)
                          {
                              ASSERT_EQ(_data->get_type(), lockless_data::socket_stream);
                              go_a1.set_value();
                          });
    ...
    ha2->set_write_handler(lockless_data::socket_stream, [&go_a2](std::shared_ptr<channel_data> _data, std::shared_ptr<router_info>)
                          {
                              ASSERT_EQ(_data->get_type(), lockless_data::socket_stream);
                              go_a2.set_value();
                          });
    ...
    ha3->set_write_handler(lockless_data::socket_stream, [&go_a3](std::shared_ptr<channel_data> _data, std::shared_ptr<router_info>)
                          {
                              ASSERT_EQ(_data->get_type(), lockless_data::socket_stream);
                              go_a3.set_value();
                          });
    ...
    hb1->set_write_handler(lockless_data::socket_stream, [&go_b1](std::shared_ptr<channel_data> _data, std::shared_ptr<router_info>)
                          {
                              ASSERT_EQ(_data->get_type(), lockless_data::socket_stream);
                              go_b1.set_value();
                          });
    ...
    hb2->set_write_handler(lockless_data::socket_stream, [&go_b2](std::shared_ptr<channel_data> _data, std::shared_ptr<router_info>)
                          {
                              ASSERT_EQ(_data->get_type(), lockless_data::socket_stream);
                              go_b2.set_value();
                          });
    ...
    hb3->set_write_handler(lockless_data::socket_stream, [&go_b3](std::shared_ptr<channel_data> _data, std::shared_ptr<router_info>)
                          {
                              ASSERT_EQ(_data->get_type(), lockless_data::socket_stream);
                              go_b3.set_value();
                          });
    ...
    hc->set_write_handler(lockless_data::socket_stream, [&go_c](std::shared_ptr<channel_data> _data, std::shared_ptr<router_info>)
                         {
                             ASSERT_EQ(_data->get_type(), lockless_data::socket_stream);
                             go_c.set_value();
                         });
    ...
    hc1->set_write_handler(lockless_data::socket_stream, [&go_c1](std::shared_ptr<channel_data> _data, std::shared_ptr<router_info>)
                          {
                              ASSERT_EQ(_data->get_type(), lockless_data::socket_stream);
                              go_c1.set_value();
                          });
    ...
    ASSERT_TRUE(wait_for(g_wait_interval, [this](std::promise<void> &go){
        ...
        m_pipeline_context->post_route_write_data(data, info, [&go](std::future<int> _fut)
                                                 {
                                                     int count = _fut.get();
                                                     ASSERT_EQ(count, 10);
                                                     go.set_value();
 ...
 */
TEST_F(channel_pipeline_context_test, route_write_data_all_2)
{
    preparePipelineContext();
 ...
 */
TEST_F(channel_pipeline_context_test, route_write_data_all_3)
{
    preparePipelineContext();
 ...
 */
TEST_F(channel_pipeline_context_test, route_write_data_exactly_1)
{
    preparePipelineContext();
 ...
 */
TEST_F(channel_pipeline_context_test, route_write_data_exactly_2)
{
    preparePipelineContext();
 ...
 */
TEST_F(channel_pipeline_context_test, route_write_data_any_1)
{
    preparePipelineContext();
 ...
 */
TEST_F(channel_pipeline_context_test, route_write_data_any_2)
{
    preparePipelineContext();
